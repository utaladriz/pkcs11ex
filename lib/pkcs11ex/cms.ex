defmodule Pkcs11ex.CMS do
  ...
  The signing primitive itself is hardware-backed: `Pkcs11ex.CMS` builds
  ...
  adapters (`Pkcs11ex.PDF` PAdES, future `Pkcs11ex.CAdES`). Like
  `Pkcs11ex.JWS`, it composes Layer 2 (`Pkcs11ex.sign_bytes/2`) and
